...
def manyPdfToTxt (i):
    fileDir = '/data/wth/Mine_data/untransformed/splited_data/' + str(i)
...
if __name__ == '__main__':
    for i in range(127):
        p = Process(target=manyPdfToTxt, args=(i,))
        p.start()
...
def manyPdfToTxt (fileDir):
    ...
    for file in files:
        ...
        print('Finished!')
fileDir = '/home/wth/data/raw_data/Metamorphic_rock/txt/100txt/58'
